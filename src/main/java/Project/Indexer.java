...
//            //test pageSize
//            System.out.println("test pageSize");
...
//            System.out.println("test forwardIndex");
...
//            System.out.println("testing title inverted index");
...
//            }
            ...
            System.out.println("testing body inverted index");
            HTree convtable_keywordIdToUrlIdTitle;
            long recid_titleInvertedIndex = recman.getNamedObject("bodyInvertedIndex");
            if(recid_titleInvertedIndex != 0)
            {
                System.out.println("1");
                convtable_keywordIdToUrlIdTitle = HTree.load(recman,recid_titleInvertedIndex);
            ...
            else
            {
                System.out.println("2");
                convtable_keywordIdToUrlIdTitle = HTree.createInstance(recman);
                recman.setNamedObject("bodyInvertedIndex",convtable_keywordIdToUrlIdTitle.getRecid());
            }
            FastIterator it6 = convtable_keywordIdToUrlIdTitle.keys();
            String key6;
            while((key6 = (String)it6.next())!=null)
